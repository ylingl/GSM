...
<!--                 	<span class="routeChartCloseBtn" style="width:1%;height:1.5%;vertical-align: middle;text-align: center;cursor:pointer;position:absolute;top:17%;left:52%;z-index:1001;display:none;color:black;background-color:white;"> x</span> -->
    ...
    <!--  <div class="warnText" id="SweepOffLine0" style="display:none;" >
     ...
     <!--离线数据盒子开始 -->
    <!--  <div class="warnText" id="setDivIdRouteText" style="display:none;">
		<div class="warnTextDiv" style="margin-top:92px;">路测离线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#fff;">></span></div>
	</div> -->
    <div id="setDivIdRoute" style="display:none;">
     ...
     <form action="/Tsme/history/simulationOnlineUploadFile" method="post" enctype="multipart/form-data" style="margin-left:14%;">
        ...
        <!--          <div style="margin:2% 0;position:relative;"> -->
        <!--              <i class="searchIcon" style="position: absolute;left: 0;top:3px;background-image: url('/Tsme/images/map/searchIconNew.png');;background-repeat: no-repeat;background-position: 0px 0px;width: 20px;height: 20px;"></i><input type="text" id="lixianSearch">  <img src="/Tsme/images/map/lixianadd.png" style="margin-left:25%;"><a href="#" style="color:white;text-decoration:none;" id="routeChuanData">上传数据</a> -->
        <!--          </div> -->
     ...
     <ul id="sitemap">
            <li><span  id="routeBigDeviceLuJuBig"></span><a href="#" style="color:#333;" id="routeBigDeviceLuJuTextBig">广铁局1</a>
                <ul id="routeBigDeviceBoxBig" style="display:none;">
                    <li><span  id="routeBigDeviceIconBig"></span><a href="#" style="color:#333;" id="routeBigDeviceIconTextBig">设备002</a>
...
<!--     小范围开始 -->
        ...
        <ul id="sitemap">
            <li><span  id="routeBigDeviceLuJu"></span><a href="#" style="color:#333;" id="routeBigDeviceLuJuText">广铁局1</a>
                <ul id="routeBigDeviceBox" style="display:none;">
                    <li><span  id="routeBigDeviceIcon"></span><a href="#" style="color:#333;" id="routeBigDeviceIconText">设备002</a>
    ...
    <!--离线数据盒子结束 -->
<!-- 	定点右侧导航栏内容开始 -->
	<!-- <div class="warnText" id="warnText" style="display:block;">
		<div class="warnTextDiv">定点监测&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#fff;">></span></div>
	</div> -->
	
	<!-- 左边导航移入显示结构开始 -->
   <div class="pointIConBg"></div>
   <!-- <div class="pointActiveBox">  -->
  ...
  <!--  </div>  -->
   <div id="warnDivId2" style="width:0;heigt:0;"></div>
   <!-- 定点监测表格开始 -->
   <div class="warnDiv" id="warnDivId" style="display:none;">
		<br/>
		<div id="onlineDeviceList" style="clear:both">
			<div id="onLineList" style="padding-left:12px; font-family:Microsoft YaHei; color:#333;">
...
$(function(){
	...
	$("#pointCtrol").mouseover(function (){  
        ...
        //$("#warnDivId").toggle(500);
       
        $("#setDivIdRoute").hide();  
//         $("#setDivId").hide(); 
    }).mouseout(function (){  
    	//添加背景色
    	/* $("#pointCtrol").removeClass("pointImgActive");
    	$("#warnDivId").css("left","3.5%");
		$("#warnText").hide();
        $("warnDivId").hide(); 
        $("#setDivIdRoute").hide(); */
//         $("#setDivId").hide(); 
