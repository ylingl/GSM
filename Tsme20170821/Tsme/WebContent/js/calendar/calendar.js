...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#B1CBEB","bg_over":"#FFFFFF","bg_out":"#F7AAC1"}
};
...
Calendar.prototype.draw = function() {
	...
	this.form.clearButton.onclick = function () {calendar.dateControl.value = "";validateDate();calendar.hide();}
	this.form.closeButton.onclick = function () {validateDate();calendar.hide();}
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #99BBE8;width:200px;height:220px;">');
...
__ci.document.writeln('table {cursor:pointer;border:0px solid #CCCCCC;background-color:#FFFFFF}');
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#DFE8F6;width:24px;}');
...
__ci.document.writeln('td.sat {color:#0000FF;background-color:#FFFFFF;}');
__ci.document.writeln('td.sun {color:#FF0000;background-color:#FFFFFF;}');
__ci.document.writeln('td.normal {background-color:#FFFFFF;}');
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#DFE8F6;width:25px;height:20px;align:right;valign:middle;}');
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#DFE8F6;width:25px;height:20px;align:left;valign:middle;}');
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#DFE8F6;width:100%;height:20px;}');
__ci.document.writeln('-->');
...
document.onclick=function(event){
	...
	if(calendar.dateControl != iTarget) calendar.hide();
};